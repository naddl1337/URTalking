<%@ Page Title="Konto verwalten" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="UR_Talking.Account.Manage" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button runat="server" Text="Entfernen" CommandName="Delete" CausesValidation="false" 
                            ToolTip='<%# "Dieses entfernen: " + Item.ProviderDisplayName + " Anmeldung aus Ihrem Konto" %>'
